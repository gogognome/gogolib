 ...
 */
public class HsqlDbDAOPlugin extends AbstractDAO implements DBMSSpecificDAOPlugin {

	public HsqlDbDAOPlugin(Connection connection, Table table) {
	...
	public void createTable() throws SQLException {
        ...
        try {
            ...
            logger.debug("createTable(): statement = " + sb.toString());
