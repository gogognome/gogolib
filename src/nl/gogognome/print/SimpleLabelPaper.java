/*
 * $Id: SimpleLabelPaper.java,v 1.1 2007-08-02 20:01:52 sanderk Exp $
 *
...
/**
 * This class implements a paper of which the number of rows and columns are configurable.  
 */
public class SimpleLabelPaper implements LabelPaper {
    ...
    public SimpleLabelPaper(int nrRows, int nrColumns) {
        this.nrRows = nrRows;
    ...
    /**
     * @see nl.gogognome.print.LabelPaper#getNrAvailableLabels()
     */
    ...
    /**
     * @see nl.gogognome.print.LabelPaper#getNrColumns()
     */
    ...
    /**
     * @see nl.gogognome.print.LabelPaper#getNrRows()
     */
    ...
    /**
     * @see nl.gogognome.print.LabelPaper#isLabelAvailble(int, int)
     */
